...
# granular ELO 
adhd_elo_breaks <- quantile(
  c(adhd_player_moves$white_elo, adhd_player_moves$black_elo),
  probs = seq(0, 1, 0.1)  # Using deciles instead of quintiles
)
