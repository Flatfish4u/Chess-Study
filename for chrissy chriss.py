...
def fetch_lichess_games(username, max_games=1):
    ...
    if response.status_code != 200:
        logging.warning(f"Failed to fetch games for user '{username}'. Status code: {response.status_code}")
        return []
        ...
        try:
            ...
            while node.variations:
                ...
                move_data = {
                    ...
                    'UnderTimePressure': time_remaining is not None and time_remaining < 20,
                    'Group': group_label,
